<%@ page import="kr.or.ddit.prod.controller.ProdUpdateControllerServlet"%>
...
<form:form modelAttribute="${ProdUpdateControllerServlet.MODELNAME}"
	...
	<table>
		<tr>
			<th>상품코드</th>
			<td>
				<form:input type="text" path="prodId" required="true"
					class="form-control" />
		...
		<tr>
			...
			<td><form:input type="text" path="prodName"
					cssClass="form-control" /> <form:errors path="prodName"
					element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>상품분류</th>
			<td><form:input type="hidden" path="prodLgu"
					cssClass="form-control" /> <form:errors path="prodLgu"
					element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>거래처</th>
			<td><form:input type="hidden" path="prodBuyer"
					cssClass="form-control" /> <form:errors path="prodBuyer"
					element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>구매가</th>
			<td><form:input type="number" path="prodCost"
				...
				<form:errors path="prodCost" element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>판매가</th>
			<td><form:input type="number" path="prodPrice"
					cssClass="form-control" />
				<form:errors path="prodPrice" element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>세일가</th>
			<td><form:input type="number" path="prodSale"
					cssClass="form-control" />
				<form:errors path="prodSale" element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>요약정보</th>
		...
		<tr>
			...
			<td><form:input type="text" path="prodDetail"
					cssClass="form-control" />
				<form:errors path="prodDetail" element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>이미지</th>
			<td>
		...
		<tr>
			...
			<td><form:input type="text" path="prodSize"
					cssClass="form-control" />
				<form:errors path="prodSize" element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>색상</th>
			<td><form:input type="text" path="prodColor"
					cssClass="form-control" />
				<form:errors path="prodColor" element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>배송방법</th>
		...
		<tr>
			...
			<td><form:input type="text" path="prodUnit"
					cssClass="form-control" />
				<form:errors path="prodUnit" element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>입고량</th>
			<td><form:input type="number" path="prodQtyin"
					cssClass="form-control" />
				<form:errors path="prodQtyin" element="span" cssClass="text-danger"></form:errors></td>
		</tr>
		<tr>
			<th>출고량</th>
...
<script
	src="${pageContext.request.contextPath }/resources/js/app/prod/prodForm.js">
