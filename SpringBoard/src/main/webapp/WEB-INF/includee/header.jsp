		...
		<ul class="d-flex align-items-center">
			...
			<c:if test="${empty principal}">
				<li class="nav-item"><a class="nav-link collapsed"
					href="<c:url value="/login/loginForm.jsp"/>"> <i
			...
			<c:if test="${not empty principal}">
				<li class="nav-item dropdown pe-3"><a
					...
					href="#" data-bs-toggle="dropdown"> <img
						src="${pageContext.request.contextPath}/resources/NiceAdmin/assets/img/profile-img.jpg"
						alt="Profile" class="rounded-circle"> <span
						class="d-none d-md-block dropdown-toggle ps-2">${principal.realUser.memName}</span>
						...
						<li>
							<form id="logoutForm" method="post">
								<a href="<c:url value="/login/logout.do" />"
									...
									data-target-form="#logoutForm">로그아웃</a> <i
